...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      className={cn("h-7 gap-2 px-2", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-blue-500 data-[active=true]:text-white data-[active=true]:[&>svg]:text-white data-[active=true]:hover:bg-blue-600",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
